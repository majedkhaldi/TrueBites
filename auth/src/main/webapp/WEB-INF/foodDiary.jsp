					...
					<div class="card">
						...
						<form action="/searchBrinner" method="get">
							<div class="meal-option">
								<span>Breakfast</span> <span class="plus-sign"
									data-target="#breakfast-search">+</span>
							</div>
							<div id="breakfast-search" class="search-bar">
								<input type="text" class="form-control" name="query"
									placeholder="Search for breakfast options..."> <input
									type="hidden" name="type" value="breakfast">
						...
						<form action="/searchBrinner" method="get">
							<div class="meal-option">
								<span>Lunch</span> <span class="plus-sign"
									data-target="#lunch-search">+</span>
							</div>
							<div id="lunch-search" class="search-bar">
								<input type="text" class="form-control" name="query"
									placeholder="Search for lunch options..."> <input
									type="hidden" name="type" value="lunch">
								<button type="submit" class="btn btn-primary">Search</button>
            ...
            <div class="card-container">
                <div class="card">
                    ...
                    <form action="/searchBrinner" method="post">
						...
						<form action="/searchBrinner" method="get">
							<div class="meal-option">
								<span>Snack</span> <span class="plus-sign"
									data-target="#snack-search">+</span>
							</div>
							<div id="snack-search" class="search-bar">
								<input type="text" class="form-control" name="query"
									placeholder="Search for snack options..."> <input
									type="hidden" name="type" value="snack">
								<button type="submit" class="btn btn-primary">Search</button>
...
<!--  delete the above if it desnt work -->
			...
			<script>
				document.querySelectorAll('.plus-sign').forEach(
						function(plusSign) {
    ...
    const remainingCalories = totalCalories - consumedCalories;
				...
				const calorieChart = new Chart(document
						.getElementById('calorieChart'), config);
			</script>
</body>
</html>
