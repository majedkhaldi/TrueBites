            ...
            <div class="row m-l-0 m-r-0">
                <div class="col-sm-4 bg-c-lite-green user-profile">
                    <div class="card-block text-center text-white">
                        <div class="m-b-25">
                            <img src="/images/blank-profile-picture-973460_960_720.webp" class="img-radius" alt="User-Profile-Image">
                        </div>

                        <h6 class="f-w-600"><c:out value="${user.username}"/></h6>
                        <a href="/user/edit"><button id="edit-profile" type="button" class="add-to-cart" data-product-tile="add-to-cart">Edit Profile</button></a>                    </div>

                </div>
                <div class="col-sm-8">
                    <div class="card-block">
                        <h6 class="m-b-20 p-b-5 b-b-default f-w-600">Your Information</h6>
                        <div class="row">
                            <div class="col-sm-12">

                                <p class="m-b-10 f-w-600">User Name: </p>

                                <h6 class="text-muted f-w-400"> <c:out value="${user.username}"/></h6>
